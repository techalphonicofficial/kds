...
export default async function TermConditions() {
  ...
  const { termsAndConditions, siteInfo } = data;

  // Format the last updated date
  const lastUpdated = new Date(termsAndConditions.lastUpdated).toLocaleDateString('en-IN', {
    year: 'numeric',
    month: 'long',
    day: 'numeric'
  });
    ...
    <main className="overflow-hidden bg-white dark:bg-[#0d1117] transition-colors duration-500">
      ...
      <section className="relative mt-5 pt-5 pb-5 hero-bg overflow-hidden">
        ...
        <div className="container mx-auto mt-5 px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            <span className="ms-3 gradient-text">Terms and Conditions.</span>
          </h1>
          <p
      ...
      <section className="section-padding bg-gray-50 dark:bg-[#161b22]/30 relative transition-colors duration-500">
        <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2" style={{ fontFamily: "Outfit, sans-serif" }}>
                  {termsAndConditions.sections[0].title}
                </h2>
                <p className="text-gray-600 dark:text-[#8b949e] text-lg leading-relaxed">
                  {termsAndConditions.sections[0].content}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {termsAndConditions.sections.slice(1).map((section, index) => (
              <div 
                key={index}
              ...
              >
                ...
                <p className="text-gray-600 dark:text-[#8b949e] text-base leading-relaxed mb-4">
                  {section.content}
                </p>
